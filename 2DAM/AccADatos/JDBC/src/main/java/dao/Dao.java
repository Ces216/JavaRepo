...
public class Dao {
    ...
    /**/
    public void delete(Connection conn, List<String[]> datosFinales) throws SQLException{
    ...
    /*public void mostrarNombresInversosConLista(Connection conn) throws SQLException {
    ...
    public void insertarCompaniesBatchConTransaccion(Connection conn, List<Company> companies) {
        String sql = "INSERT INTO COMPANIES (CIF, NOMBRES, SECTOR) VALUES (?, ?, ?)";
        ...
        try {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                ...
                // Si executeBatch() no excepción hacemos permanentes los cambios.
                conn.commit();
                System.out.println("¡Éxito! La transacción ha sido confirmada (commit).");
            }
        } catch (SQLException e) {
