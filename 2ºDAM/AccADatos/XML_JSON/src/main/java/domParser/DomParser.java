...
import java.text.SimpleDateFormat;   // <-- para formatear fecha/hora
    ...
    static void main(String[] args) {
        ...
        dbf.setIgnoringElementContentWhitespace(true);
            ...
            try {
                ...
                // --- Crear PrintStream para escribir en el archivo ---
                try (PrintStream ps = new PrintStream("C:\\Users\\cesar\\ReposGitHub\\JavaRepo\\2ºDAM\\AccADatos\\XML_JSON\\src\\main\\java\\domParser\\parsings\\" + nombreSalida)) {
                    muestraNodo(domDoc, 0, ps);
                    System.out.println("Salida guardada en: " + "C:\\Users\\cesar\\ReposGitHub\\JavaRepo\\2ºDAM\\AccADatos\\XML_JSON\\src\\main\\java\\domParser\\parsings\\" + nombreSalida);
                }
